      ...
      {!isDesktop ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">€{visitorCarsRevenue}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
                Visitors Motorcycle Revenue
              </CardTitle>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <CardContent>
              <div className="text-2xl font-bold">€{visitorsMotorRevenue}</div>
            </CardContent>
          </Card>
        </div>
      )}
